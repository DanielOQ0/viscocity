        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[500px] hidden lg:block">
              {charMain && (
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-float z-10">
                  <Image
                    src={charMain}
                    alt=""
                    width={320}
              ...
              {charLeft && (
                <div className="absolute top-1/4 left-0 animate-float-delayed z-20">
                  <Image
                    src={charLeft}
                    alt=""
                    width={160}
              ...
              {charRight && (
                <div className="absolute bottom-1/4 right-0 animate-float-slow z-20">
                  <Image
                    src={charRight}
                    alt=""
                    width={180}
